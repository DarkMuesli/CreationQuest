...
public class SlotMachine implements Screen {
    ...
    private CreationQuestGame game;
    private SlotMachineInputAdapter inpAd;
    private SlotMachineControllerAdapter contAd;

    private Reel[] reels;

    public SlotMachine(SpriteBatch spriteBatch, OrthographicCamera cam, CreationQuestGame CreationQuestGame) {
        this.spriteBatch = spriteBatch;
        this.cam = cam;
        this.game = CreationQuestGame;
    ...
    public CreationQuestGame getGame() {
        return game;
    }

    public void setGame(CreationQuestGame game) {
        this.game = game;
    }
